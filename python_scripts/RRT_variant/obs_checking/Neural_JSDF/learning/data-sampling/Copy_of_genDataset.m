...
N_JPOS = 1; %value used in the paper  
% N_JPOS = 50;
...
q_rand = [0,0,0,-2,0,0,0,0];
% q_rand = [2.9632,  1.7820, -2.0959, -3.1082,  1.6234,  0.7221, -1.5457, 0];
tic
dataset = [];
for i = 1:N_JPOS
    i
...
% data_old = load("datasets/data_mesh_test.mat");
% dataset = [data_old.dataset; dataset];
toc
